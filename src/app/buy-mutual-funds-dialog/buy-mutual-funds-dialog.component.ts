...
@Component({
  selector: 'app-buy-mutual-funds-dialog',
  templateUrl: './buy-mutual-funds-dialog.component.html',
  styleUrls: ['./buy-mutual-funds-dialog.component.css'],
})
export class BuyMutualFundsDialogComponent implements OnInit {
  form!: FormGroup;
  error: string = '';
  constructor(
    ...
    private dialogRef: MatDialogRef<BuyMutualFundsDialogComponent>,
